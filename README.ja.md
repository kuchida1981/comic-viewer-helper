...
*   **レジューム機能**: 前回読んでいたページ位置を記憶し、再度同じ作品を開いた際に続きから読むか選択できます。
*   **見開き表示 (Spread)**: 単ページ表示と見開き表示を切り替えて、紙の雑誌のような感覚で閲覧できます。
*   **プログレスバー**: 読書の進捗状況を視覚的に確認できます。
*   **キーボードナビゲーション**: キーボードショートカットを使用して素早くページを移動できます。
*   **レスポンシブ調整**: ブラウザのサイズに合わせて画像を自動的にフィットさせます。
