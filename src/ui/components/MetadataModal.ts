  ...
  const { title, tags, relatedWorks } = metadata;
    ...
    const closeBtn = createElement('button', {
      ...
      events: {
        ...
        click: function handleMetadataCloseClick(e: Event) {
    ...
    const tagChips = tags.map(function renderMetadataTagChip(tag) {
      ...
      return createElement('a', {
        ...
        events: {
          ...
          click: function handleMetadataTagClick(e: Event) {
    ...
    const relatedItems = relatedWorks.map(function renderMetadataRelatedWork(work) {
      ...
      return createElement('a', {
        ...
        events: {
          ...
          click: function handleMetadataRelatedClick(e: Event) { e.stopPropagation(); }
    ...
    const content = createElement('div', {
      ...
      events: {
        ...
        click: function handleMetadataContentClick(e: Event) { e.stopPropagation(); }
    ...
    const overlay = createElement('div', {
      ...
      events: {
        ...
        click: function handleMetadataOverlayClick(e: Event) {
    ...
    return {
      ...
      update: function noopUpdate() { } // No dynamic update needed once opened
